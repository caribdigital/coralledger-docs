...
4. Submit the amendment through the same workflow - validation, finalisation acknowledgement, signatory capture, artifact generation, and Record DIR Acknowledgement.
