...
| **Ready to File** | Ready to File | All validations passed and the Penalty acknowledgement + signatory have been captured. The return is locked from edits |
...
- [Filing Wizard](/docs/vat-returns/filing-wizard) - penalty acknowledgement, signatory capture, and artifact generation
