...
- **Penalties** - Up to 200% of unpaid VAT (VAT Act Section 61)
...
- Vendor intelligence
- Entropy analysis for data consistency

### Anomaly Detection
Our system flags potential issues:
- Statistical outlier detection
- Unusual transaction patterns
- Category inconsistencies
- Duplicate transactions

### 2025 VAT Reform Dashboards
...
- [Claim Bad Debt Relief](/docs/compliance/bad-debt-relief)
