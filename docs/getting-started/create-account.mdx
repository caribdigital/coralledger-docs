...
See the public [pricing page](https://www.coralledger.com/pricing) for the current per-taxpayer commercial terms.
:::
...
| Unit | Standard price | Qualification / treatment |
|---|---:|---|
| Active taxpayer (one nine-digit TIN) | B$199/mo | Full access while active |
| First 25 activated taxpayers | B$59/mo | Founding allocation while active |
| Deregistered taxpayer | B$19/mo | Read-only and exportable from next billing month |
| Qualifying paired referral | Up to B$20/mo credit | Five pairs maximum; never below B$59/mo |

During open beta, all features are available at no cost. The public pricing page, FAQ, calculator, metadata, and schema are the source for current commercial copy.
...
- [Review subscription and billing](/docs/billing)
