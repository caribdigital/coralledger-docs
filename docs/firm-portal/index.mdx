...
|---|---|---|---|
| **Active taxpayer** | Per VAT registration (nine-digit TIN) | B$199/mo standard; first 25 activated taxpayers B$59/mo | Current public contract |
| **Deregistered taxpayer** | Read-only retained record | B$19/mo from next billing month | Exportable history |
| **Paired referral** | Five qualifying pairs maximum | Up to B$20/mo credit each | Never below B$59/mo |
