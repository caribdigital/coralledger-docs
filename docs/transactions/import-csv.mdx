...
<DemoVideo src="https://cdn.coralledger.com/demos/transactions-03.mp4" title="Transactions — CSV Import and Column Mapping" />
...
### Step 3: Map Columns
- Match your CSV columns to CoralLedger Comply fields
